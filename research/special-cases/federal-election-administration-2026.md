...
| CLM-08 | The 2025 enhanced SAVE system added natural-born citizen records, SSA/SSN access, and bulk search capabilities. | **Verified** | SAV-013 | Federal court opinion based on administrative record | This was the enhanced federal architecture available during Tennessee's 2025 large-scale comparison; Tennessee's exact query-file fields are not independently documented. |
...
| 2025 enhanced SAVE | Tennessee 4m-record check | Tennessee used enhanced SAVE at statewide scale; the exact query-file fields used by Tennessee remain partially undocumented. | **Documented operational connection; implementation details qualified** | SAV-009; Hargett later confirms SAVE/last-four-SSN work. |
